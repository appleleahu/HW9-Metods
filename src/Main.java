...
public class Main {
    public static void main(String[] args) {
        ...
        //то должно быть выведено “*номер года —* високосный год”. Если год не високосный, то, соответственно: “*номер года —* не **високосный год”.
        ...
        //        ``javaint currentYear = LocalDate.now().getYear();```
        ...
        int distance = 95;
        System.out.printf("Колиество дней доставки для росстояния %d км. равно %d дней.%n", distance,deliveryTime(distance));
    }
    ...
    private static void suggestOs (int os, int deviceYear) {
        String resultString = buildResultsString(os, deviceYear);
    ...
    private static int deliveryTime (int distance){
        ...
        if (distance <=20){
            ...
            return ((int) Math.ceil((distance - 20) / 40d)) + defaultDeliveryTime;
        }
    }

    private static String buildResultsString(int os, int deviceYear) {
        int currentYear = LocalDate.now().getYear();
        StringBuilder stringBuilder = new StringBuilder();
        if (deviceYear < currentYear) {
            stringBuilder.append("Установите lite - версию приложения для: ");
        } else {
            stringBuilder.append("Установите full - версию приложения для: ");
        }
        if (os == 1) {
